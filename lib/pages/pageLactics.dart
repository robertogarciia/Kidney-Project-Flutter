...
class pageLactics extends StatefulWidget {
  final String userId;
  final String tipusC;

  const pageLactics({Key? key, required this.userId, required this.tipusC})
      : super(key: key);

  @override
  _pageLacticsState createState() => _pageLacticsState();
}

class _pageLacticsState extends State<pageLactics> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Làctics Disponibles'),
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('Dietes')
            .where('Categoria', isEqualTo: 'Lactic')
            .snapshots(),
