...
class pageLlegums extends StatefulWidget {
  final String userId;
  final String tipusC;

  const pageLlegums({Key? key, required this.userId, required this.tipusC})
      : super(key: key);

  @override
  _pageLlegumsState createState() => _pageLlegumsState();
}

class _pageLlegumsState extends State<pageLlegums> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Llegums Disponibles'),
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('Dietes')
            .where('Categoria', isEqualTo: 'Llegums')
            .snapshots(),
