...
class pageFruita extends StatefulWidget {
  final String userId;
  final String tipusC;

  const pageFruita({Key? key, required this.userId, required this.tipusC})
      : super(key: key);

  @override
  _pageFruitaState createState() => _pageFruitaState();
}

class _pageFruitaState extends State<pageFruita> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Fruita Disponibles'),
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('Dietes')
            .where('Categoria', isEqualTo: 'Fruita')
            .snapshots(),
