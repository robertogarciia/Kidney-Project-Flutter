...
class pageVerdures extends StatefulWidget {
  final String userId;
  final String tipusC;

  const pageVerdures({Key? key, required this.userId, required this.tipusC})
      : super(key: key);

  @override
  _pageVerduresState createState() => _pageVerduresState();
}

class _pageVerduresState extends State<pageVerdures> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Verdures Disponibles'),
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('Dietes')
            .where('Categoria', isEqualTo: 'Verdura')
            .snapshots(),
